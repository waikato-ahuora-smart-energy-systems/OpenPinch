...
Run the complete supported non-solver, Notebook 2, packaging, and static gates:
...
Build the distribution and run the full-precision reconstruction smoke outside
the source checkout using the extracted wheel.
