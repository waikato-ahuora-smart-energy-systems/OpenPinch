...
from OpenPinch.domain.targets import BaseTargetModel, DirectIntegrationTarget
...
def test_stream_collection_edge_paths():
    ...
    csv_path = export_stream_collection(
        sc3,
        filename="stream_collection_export_test",
    )
...
def test_target_model_and_zone_property_branches():
    ...
    payload_same = serialize_target(t, isTotal=True)
    ...
    t.hot_pinch = None
    t.cold_pinch = 95.0
    payload_cold = serialize_target(t, isTotal=False)
