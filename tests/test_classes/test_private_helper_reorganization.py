...
def test_owner_package_hierarchy_and_retired_paths() -> None:
    ...
    expected = {
        ...
        "_pinch_workspace/views/common.py",
        "_pinch_workspace/views/graphs.py",
        "_pinch_workspace/views/inputs.py",
        "_pinch_workspace/views/problem_tables.py",
        "_pinch_workspace/views/variants.py",
