"""Tests covering plotting helpers in ``OpenPinch.presentation.graphs.simple``."""

from __future__ import annotations

import numpy as np

from OpenPinch.presentation.graphs.simple import (
    _require_plotly,
...
def test_graph_simple_cc_plot_executes_show(monkeypatch):
    ...
    monkeypatch.setattr(
        "OpenPinch.presentation.graphs.simple._require_plotly", lambda: _FakePlotly
    )
