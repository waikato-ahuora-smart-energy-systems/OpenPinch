...
from OpenPinch.domain._stream import linearisation as sl
from OpenPinch.domain._stream.linearisation import *
from tests.support.paths import FIXTURES_ROOT


def import_t_h_data(filename):
    """Load t h data used by this test module."""
    json_path = FIXTURES_ROOT / "linearise_stream" / f"{filename}.json"
