...
- notebook and script workflows built around :class:`OpenPinch.PinchProblem`
...
Most users should stay at the `PinchProblem` or CLI level. Advanced users can
drop into schemas, service entrypoints, prepared `Zone` trees, or lower-level
analysis helpers when they need more control.
