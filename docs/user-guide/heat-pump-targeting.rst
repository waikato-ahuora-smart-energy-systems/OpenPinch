...
This page has moved, but the current heat pump integration entrypoints are
still worth calling out here for compatibility:
...
- the legacy sample payload name ``heat_pump_targeting.json``
