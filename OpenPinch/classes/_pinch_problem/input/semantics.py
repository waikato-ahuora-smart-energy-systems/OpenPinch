"""Semantic validation for schema-valid problem input records."""
...
from ....lib.schemas.workspace import ValidationIssue
...
_STREAM_OPTIONAL_VALUE_FIELDS = _STREAM_VALUE_FIELDS
...
def semantic_issues(
    ...
    *,
    ...
    from .validation import validation_record_label
