...
CONFIG_FIELD_SPECS: dict[str, ConfigurationFieldSpec] = {
    ...
    "TOP_ZONE_IDENTIFIER": ConfigurationFieldSpec(
        str,
        ZT.S.value,
        "general",
        enum_cls=ZT,
    ...
    "DT_PHASE_CHANGE": ConfigurationFieldSpec(
        float,
        0.01,
        "general",
        numeric_min=0.0,
    ),
    "DT_ASSISTED_HT": ConfigurationFieldSpec(
        float,
        10.0,
        "general",
        numeric_min=0.0,
    ...
    "DO_INDIRECT_PROCESS_TARGETING": ConfigurationFieldSpec(
        bool,
        False,
        "targeting",
    ),
    ...
    "PRICE_RATIO_COLD_TO_ELE": ConfigurationFieldSpec(
        float,
        1.0,
        "hpr",
        numeric_min=0.0,
    ),
    "MAX_HP_MULTISTART": ConfigurationFieldSpec(
        int,
        10,
        "hpr",
        numeric_min=0.0,
    ...
    "ETA_II_HE_CARNOT": ConfigurationFieldSpec(
        float,
        0.5,
        "hpr",
        numeric_min=0.0,
    ...
    "DT_HPR_CASCADE_HX": ConfigurationFieldSpec(
        float,
        0.0,
        "hpr",
        numeric_min=0.0,
    ),
    "BB_MINIMISER": ConfigurationFieldSpec(
        str,
        BB_Minimiser.CMAES.value,
        "hpr",
        enum_cls=BB_Minimiser,
    ),
    ...
    "UTILITY_PRICE": ConfigurationFieldSpec(
        float,
        100,
        "costing",
        numeric_min=0.0,
    ),
    "ANNUAL_OP_TIME": ConfigurationFieldSpec(
        float,
        8300,
        "costing",
        numeric_min=0.0,
    ...
    "VARIABLE_COST": ConfigurationFieldSpec(
        float,
        10000,
        "costing",
        numeric_min=0.0,
    ...
    "DISCOUNT_RATE": ConfigurationFieldSpec(
        float,
        0.07,
        "costing",
        numeric_min=0.0,
    ...
    "LOAD_FRACTION": ConfigurationFieldSpec(
        float,
        1,
        "turbine",
        numeric_min=0.0,
    ...
    "TURB_MODEL": ConfigurationFieldSpec(
        str,
        TurbineModel.MEDINA_FLORES.value,
        "turbine",
        enum_cls=TurbineModel,
    ),
