...
from ...domain.enums import LegendSeries, ProblemTableLabel, StreamLoc
...
GRAPH_SERIES_META: dict[str, _GraphSeriesMeta] = {
    ...
    ProblemTableLabel.X_SUR.value: _GraphSeriesMeta(
        label="Exergy Surplus",
        description="Exergy Surplus",
        composite_title="Exergy Surplus",
    ),
    ProblemTableLabel.X_DEF.value: _GraphSeriesMeta(
