...
from .multi_simple_carnot import _optimise_multi_simple_carnot_heat_pump_placement
from .shared import (
...
__all__ = [
    "_optimise_multi_simple_heat_pump_placement",
...
def _optimise_multi_simple_heat_pump_placement(
    ...
    init_res = (
        _optimise_multi_simple_carnot_heat_pump_placement(args)
