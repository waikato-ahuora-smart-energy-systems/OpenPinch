...
def complete_core_state(
    *,
    ...
    t_supply_arr = value_state.value_array(
        t_supply,
        size=state_size,
        stream_name=stream_name,
    )
    t_target_arr = value_state.value_array(
        t_target,
        size=state_size,
        stream_name=stream_name,
    )
    heat_flow_arr = value_state.value_array(
        heat_flow,
        size=state_size,
        stream_name=stream_name,
    )
    ...
    if np.any(equal_mask):
        ...
        t_target = value_state.build_value(
            adjusted_target_arr,
            unit=t_supply.unit,
...
def derive_stream_state(
    *,
    ...
    htc_arr = value_state.value_array(
        htc,
        size=state_size,
        stream_name=stream_name,
    )
    price_arr = value_state.value_array(
        price,
        size=state_size,
        stream_name=stream_name,
    )
    dt_cont_arr = value_state.value_array(
        dt_cont,
        size=state_size,
        stream_name=stream_name,
    )
    ...
    build_value = value_state.build_value
